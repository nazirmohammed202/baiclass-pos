  ...
  return (
    <main className="p-3 sm:p-4 lg:p-6">
      <div className="max-w-lg mx-auto bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-lg p-6 sm:p-8 text-center space-y-4">
        <CircleDollarSign className="w-12 h-12 mx-auto text-gray-400 dark:text-gray-500" />
        <h1 className="text-xl sm:text-2xl font-bold">End of Day</h1>
        <p className="text-gray-600 dark:text-gray-400">
          Cash reconciliation and Z-report will be available once the backend
          API is implemented. See{" "}
