...
function getExpenseDate(expense: ExpenseType): string {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-neutral-900 rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
        ...
        <p className="text-center text-gray-600 dark:text-gray-400 mb-4">
          This action cannot be undone. The following expense will be permanently removed:
        </p>
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-900 dark:text-gray-100">
                {formatCurrencyToDisplay(expense.amount)}
              </span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-900 dark:text-gray-100">
                {formatTimestampToDisplay(getExpenseDate(expense)) || "—"}
              </span>
            </div>
          </div>
        </div>
        <div className="flex gap-3">
          ...
          <button
            onClick={onConfirm}
            disabled={isDeleting}
            className="flex-1 px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {isDeleting ? (
              <>
