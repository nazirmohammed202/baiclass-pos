...
export default function DeleteSupplierModal({
  ...
  const phoneDisplay = Array.isArray(supplier.phoneNumbers) ? supplier.phoneNumbers.join(", ") : "";
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-neutral-900 rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
        ...
        <h2 className="text-lg font-semibold text-center text-gray-900 dark:text-gray-100 mb-2">Delete Supplier?</h2>
        <p className="text-center text-gray-600 dark:text-gray-400 mb-4">
          This action cannot be undone. The following supplier will be permanently removed:
        </p>
          ...
          <div className="space-y-2 text-sm">
            ...
            {phoneDisplay && (
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-gray-100">{phoneDisplay}</span>
              </div>
            )}
          </div>
        </div>
