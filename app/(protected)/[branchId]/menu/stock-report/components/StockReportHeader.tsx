...
type StockReportHeaderProps = ReturnType<typeof useStockReport>;
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-4">
        ...
        <div className="flex gap-2">
          <button
            onClick={exportToCSV}
            disabled={
              !dailySummary || dailySummary.eachDay.length === 0 || loading
            }
